 ...
 */
public abstract class ResourceCursorPagerAdapter extends CursorPagerAdapter {
     ...
     * @param layout  resource identifier of a layout file that defines the views for this list item.
     ...
     */
    public ResourceCursorPagerAdapter(Context context, int layout, Cursor c, boolean autoRequery) {
