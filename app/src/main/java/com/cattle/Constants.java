...
public final class Constants {
    ...
    public static final String PROMO_POST_URL
            = "https://play.google.com/store/apps/details?id=com.cattle";
    ...
    public static final String SINA_WEIBO_KEY = "SinaWeibo";
    public static final String TENCENT_WEIBO_KEY = "TencentWeibo";
    public static final String QZONE_KEY = "QZone";
    public static final String WECHAT_MOMENTS_KEY = "WechatMoments";
    public static final String WECHAT_FAVORITE_KEY = "WechatFavorite";
}
