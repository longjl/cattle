...
import com.cattle.events.PhotoSelectionAddedEvent;
import com.cattle.events.PhotoSelectionRemovedEvent;
import com.cattle.events.UploadsModifiedEvent;
import com.cattle.events.UploadsStartEvent;
import com.cattle.fragments.SelectedPhotosFragment;
import com.cattle.fragments.ShareFragment;
import com.cattle.fragments.UploadsFragment;
import com.cattle.fragments.UserPhotosFragment;
import com.cattle.util.Utils;
import com.cattle.views.UploadActionBarView;
import com.cattle.views.UploadsActionBarView;
...
public class PhotoSelectionActivity extends AbstractPhotoUploadActivity
    ...
    public void onClick(View v) {
        if (v == mUploadActionView) {   //分享
            if (!mPhotoController.hasSelections()) {
                Toast.makeText(this, R.string.error_select_photos, Toast.LENGTH_SHORT).show();
            } else {
                Uri uri = mPhotoController.getSelected().get(0).getOriginalPhotoUri();
                String url = Utils.getPathFromContentUri(getContentResolver(), uri);
